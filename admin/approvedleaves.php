                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="managmentmenu">
                            ...
                            <li>
                                <a href="notapprovedleaves.php">Pending Leaves</a>
                            </li>
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    ...
                    foreach ($leaves as $leave) {
                        ...
                        $html .= "<td class='text-success'>{$status}</td>";
                        $html .= '<td></td>';
                        $html .= '<td class="m-3"><a href="viewdetails.php?id=' . $leave['id'] . '"><button type="button" class="btn btn-success">View Details</button></a></td>';
                        $html .= "</tr>";
                        echo $html;
                        // var_dump($leave["id"]);
                        $inc++;
